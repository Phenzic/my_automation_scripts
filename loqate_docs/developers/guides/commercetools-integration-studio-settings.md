...
::::::::::: gd
:::::::::: {.gd__c style="--cols:12"}
::::::::: {.gd__i .section .gd--cen .full-width .api_documentation_container .pbtm--32 .c12 style="--cspan:12;--rspan:1;--cstart:1;"}
:::::::: {.section .gd__s}
::::::: {.gd__a style="--cols: 12;--cspan: 12; --rspan: 1;"}
:::::: {.gd__c style="--cols:12"}
::: {.gd__i .rte .c12 style="--cspan:12;--rspan:1;--cstart:1;"}
Refer to the [commercetools Frontend Studio
documentation](https://docs.commercetools.com/frontend-studio/accessing-the-studio){rel="noopener"
target="_blank"} for instructions on how to access the studio.

![](/media/bqsmsp25/studio-settings.png){height="722" width="1000"}
:::

:::: {.gd__i .rte .mtop--32 .c12 style="--cspan:12;--rspan:1;--cstart:1;"}
The following settings are configurable in
the `Project settings`{.language-plaintext .highlighter-rouge}, found in
the [`projectConfiguration.json`{.language-plaintext
.highlighter-rouge}](https://loqate.github.io/loqate-commercetools/docs/packages/poc/backend/commerce-commercetools/schemas/projectConfiguration.json){.external-link
rel="nofollow"} file:
