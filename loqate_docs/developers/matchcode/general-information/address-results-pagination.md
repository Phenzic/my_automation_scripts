...
The Matchcode address web services support pagination of search results,
allowing chunks of results to be returned as the user wants. This
pagination is controlled via the **maxReturn** and **offset** properties
within the **options** component of a IDM request.

The maxReturn property specifies the maximum number of results to return
per page, and the offset property specifies the index (starting at zero)
within the total number of results to start the page at.

To request a specified page within the search results, the search should
be re-submitted again, with updated values for the maxReturn and offset
properties.

The **captureResponse** component of the IDM response contains several
properties related to pagination, listed below:
