...
:::: api-list
::: api-item
#### [International Batch Cleanse (v1)](/developers/apis/cleanse-api/international-batch-cleanse/)

**Recommended.** Our most powerful address verification & cleanse
service, including certified & enhanced datasets, geocoding & reverse
geocoding, and transliteration for a batch of up to 500 international
addresses.

[View the
API](/developers/apis/cleanse-api/international-batch-cleanse/){.link-with-arrow}
:::
::::
:::::
::::::
