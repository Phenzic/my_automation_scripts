...
[](/developers/matchcode/sample-code/integration-example-c/){.tile-item__link
aria-label="Integration Example: C#"}
...
:::::: {.gd__i .tile .c12 style="--cspan:12;--rspan:1;--cstart:auto;"}
::::: {.tile-item .tile-item--haslink}
[](/developers/matchcode/sample-code/integration-example-java/){.tile-item__link
aria-label="Integration Example: Java"}
...
:::::: {.gd__i .tile .c12 style="--cspan:12;--rspan:1;--cstart:auto;"}
::::: {.tile-item .tile-item--haslink}
[](/developers/matchcode/sample-code/integration-example-multi-threaded-java-wrapper-for-idm-globalservices/){.tile-item__link
aria-label="Integration Example: Multi-threaded Java wrapper for IdM GlobalServices"}

:::: tile__content
::: h--xs
Integration Example: Multi-threaded Java wrapper for IdM GlobalServices
:::
::::
:::::
::::::
